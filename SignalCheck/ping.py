...
#from main import MyFrame1 as windows
...
class Ping(object):
    def __init__(self, destination, timeout=1000, packet_size=55, own_id=None,windows=None):
...
def verbose_ping(hostname, timeout=1000, count=3, packet_size=55,windows=None):
    p = Ping(hostname, timeout, packet_size,windows=windows)
    p.run(count)
